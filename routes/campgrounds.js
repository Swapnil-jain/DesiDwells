...
router.route("/")
    ...
    .post(isLoggedIn, validateCampground, catchAsync(campgrounds.createCampground)); //where the new campground submits to
...
router.route("/:id")
    ...
    .put(isLoggedIn, isAuthor, catchAsync(campgrounds.editCampground)) //positing the editing form
